...
//    getGoogleAccounts 获取google账号
    ...
    @SuppressLint("NewApi") public static String getSerial() {
        return Build.SERIAL;
    }
    ...
    @SuppressLint("NewApi") public static String[] getSupportedABIS() {
    ...
    @SuppressLint("NewApi") public static String getPsuedoUniqueID() {
    ...
    @SuppressLint("NewApi") public static String getRadioVersion() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH ? Build.getRadioVersion() : "";
    }

    @SuppressLint("NewApi") public static String getUA(Context ctx) {
