...
public class OptionPicker extends WheelPicker {
    ...
    protected View initContentView() {
        ...
        WheelView optionView1 = new WheelView(activity);
        optionView1.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT));
        optionView1.setTextSize(textSize);
        optionView1.setTextColor(textColorNormal, textColorFocus);
        optionView1.setLineVisible(lineVisible);
        optionView1.setLineColor(lineColor);
        optionView1.setOffset(offset);
        layout.addView(optionView1);
